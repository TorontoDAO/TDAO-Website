<template>
    <div class="home">
        <div class="main_screen">
            <div class="single_post_container">
                <h3> Get NFT and Become <br>a TorontoDAO Member</h3>
            </div>
        </div>
        <div class="single_post_container">
            <div class="single_post">
                ...
                <div class="single_post_content">
                    ...
                    <div class="single_post_text">
                        Members of the DAO are sent 'Soul Bound' NFT memberships that allow members to vote on proposals for the DAO. These NFTs cannot be transferred and indicate the voting power of the address that claimed this NFT. Members of the DAO are sent 'Soul Bound' NFT memberships that allow members to vote on proposals for the DAO. These NFTs cannot be transferred and indicate the voting power of the address that claimed this NFT.
                        <br><br>
                        Members of the DAO are sent 'Soul Bound' NFT memberships that allow members to vote on proposals for the DAO. These NFTs cannot be transferred and indicate the voting power of the address that claimed this NFT. Members of the DAO are sent 'Soul Bound'.
                        <br><br>
                        Members of the DAO are sent 'Soul Bound' NFT memberships that allow members to vote on proposals for the DAO. These NFTs cannot be transferred and indicate the voting power of the address that claimed this NFT. Members of the DAO are sent 'Soul Bound' NFT memberships that allow members to vote on proposals for the DAO. These NFTs cannot be transferred and indicate the voting power of the address that claimed this NFT.
                    </div>
                </div>
  ...
  <style>
    ...
    .main_screen{
      padding-top: 150px;
      padding-bottom: 50px;
      background-image: url('../assets/toronto_back_dark.jpg');
